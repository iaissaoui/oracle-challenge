...
public class ZeppelinUtils {
	...
	/**
	 * get or create the note where the paragraph is executed if the call is using
	 * an existing session, return the note object of that session otherwise create
